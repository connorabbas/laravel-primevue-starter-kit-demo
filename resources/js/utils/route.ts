...
'examples.data-table.contacts.index': never,
'examples.paginator.contacts.index': never,
...
const routes = {
    ...
    "examples.data-table.contacts.index": "examples/data-table/contacts",
    "examples.paginator.contacts.index": "examples/paginator/contacts",
